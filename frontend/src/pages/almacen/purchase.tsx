// Almacenero purchase page — reutiliza la misma lógica que inventory_admin.
// La única diferencia es que la navegación de vuelta apunta a /almacen/stock.
...
export const AlmacenPurchasePage = () => {
  ...
  const { mutate: submit, isPending } = useMutation({
    mutationFn: (values: {
      ...
      fetchJson(`${apiUrl}/inventory/purchase`, {
        method: "POST",
    ...
    onError: () => message.error("Error al registrar la compra"),
  });
      ...
      <Card>
        ...
        >
          ...
          <Form.Item
            ...
            rules={[{ required: true, message: "Requerido" }]}
          >
            <InputNumber style={{ width: "100%" }} min={0.000001} precision={6} placeholder="ej: 50" />
          </Form.Item>
          ...
          <Form.Item label="Notas (opcional)" name="notes">
            <Input.TextArea rows={2} placeholder="Ej: Factura #123" />
          </Form.Item>
